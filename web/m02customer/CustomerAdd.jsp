...
<head>
    ...
    <script>
        ...
        function saveData() {
            ...
            var url = "../CustomerAddServlet?customerName=" + customerName +
        ...
        // 返回操作
        function goback() {
            document.myform.action = "CustomerMain.jsp";
            document.myform.submit();
        }
    </script>
</head>
    ...
    <fieldset>
        ...
        <table width="100%">
            <tr>
                ...
                <td colspan="3" width="30%"><input type="text" name="customerName" value="" style="width: 100%" placeholder="请输入客户名称"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3" width="30%"><input type="text" name="address" value="" style="width: 100%" placeholder="请输入地址"></td>
            </tr>
            <tr>
                <td width="20%" align="center">城市<span style="color: red;">*</span></td>
                <td width="30%"><input type="text" name="city" value="" style="width: 100%" placeholder="请输入城市"></td>
