...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectData(){
            ...
            document.getElementById("myiframe").src = "ContactPersonList.jsp?name=" + name + "&customerName=" + customerName;
        }
        ...
        function addData(){
            var name = document.myform.name.value;
            var customerName = document.myform.customerName.value;
            document.myform.action = "ContactPersonAdd.jsp?name=" + name + "&customerName=" + customerName;
